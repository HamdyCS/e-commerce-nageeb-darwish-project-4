...
import { LATEST_SALE_PRODUCTS, TOP_RATING_PRODUCTS } from "../../../Apis/Apis";
...
export default function TopRatedProducts() {
  ...
  const skeletonElments = Array.from({ length: 3 }).map((_, index) => (
    <div
      className=" p-4 h-100 mb-3  gap-3"
      style={{
        ...
        : products.map((product, index) => {
            ...
            return (
              <Link
                ...
                className="  p-4 h-100 mb-3  gap-3 text-decoration-none text-black d-block"
                style={{
                  borderBottom:
